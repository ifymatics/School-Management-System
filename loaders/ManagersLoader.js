...
const RoleManager = require("../managers/role/Role.manager");
...
module.exports = class ManagersLoader {
  ...
  load() {
    ...
    // this.injectable.mongoDB = this.mongoDB;
    //console.log("rateLimiter", mwsRepo["__rateLimiter"]);
    /*****************************************CUSTOM MANAGERS*****************************************/
    ...
    this.managers.userServer = new UserServer({
      config: this.config,
      managers: this.managers,
      ...{ rateLimiter: mwsRepo["__rateLimiter"] },
    });
